fission spec init
fission env create --spec --name onb-us-tax-resd-env --image nexus.sigame.com.br/fission-onboarding-us-tax-residency:0.1.2 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
